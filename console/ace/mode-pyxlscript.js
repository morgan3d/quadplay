...
var PyxlScriptHighlightRules = function() {
    ...
    // Do not use size or loop, which are somewhat common variable names
    var builtinFunctions = (
        ...
        "resume_audio|get_audio_status|ray_value|play_sound|resume_sound|stop_audio|game_frames|mode_frames|delay|sequence|add_frame_hook|make_spline|remove_frame_hook|make_entity|entity_mass|entity_move|entity_inertia|entity_area|draw_entity|overlaps|entity_remove_all|entity_add_child|entity_remove_child|entity_update_children|entity_simulate|split|now|game_frames|mode_frames|replace|starts_with|ends_with|find_map_path|find_path|join|entity_apply_force|entity_apply_impulse|perp|gray|rgb|rgba|hsv|hsva|last_value|last_key|insert|reverse|reversed|call|set_post_effects|get_post_effects|reset_post_effects|push_front|local_time|device_control|physics_add_contact_callback|physics_entity_contacts|physics_entity_has_contacts|physics_add_entity|physics_remove_entity|physics_remove_all|physics_attach|physics_detach|make_physics|make_contact_group|draw_physics|physics_simulate|" +
            ...
            "trim_spaces|slice|set_pause_menu|iterate|fast_remove_key|find|keys|remove_key|substring|shuffle|shuffled|sort|resize|push|pop|pop_front|push_front|fast_remove_value|remove_values|remove_all|round|floor|ceil|todo|debug_pause|debug_print|" +
            "set_playback_rate|set_pitch|set_volume|set_pan|set_loop|remove_frame_hooks_by_mode|" +
            ...
            "push_guest_menu_mode|stop_hosting|start_hosting|disconnect_guest|" +
            ...
            "XY_MAD_S_XY|XY_MAD_XY_XY|XY_ADD_XY|XY_SUB_XY|XY_MUL_XY|XY_DIV_XY|XY_MUL|XY_DIV|XY_DOT_XY|XY_CRS_XY|" +
