...
var PyxlScriptHighlightRules = function() {
    ...
    var keywords = "assert|debug_pause|debug_print|debug_watch|with_camera|let|const|mod|local|preserving_transform|for|in|and|or|xor|not|with|while|until|if|then|else|push_mode|reset_game|set_mode|return|def|break|continue|default|bitand|bitnot|bitor|bitxor|bitnot|bitshl|bitshr|because|quit_game|launch_game|∈|∊";
