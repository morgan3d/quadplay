...
<html>
  ...
  <body style="margin: 0; background: #000; position: absolute; top: 0; bottom: 0; left: 0; right: 0">
    <iframe src="console/quadplay.html?fastReload=1&game={game_path}&mode=Maximal" style="width: 100%; height: 100%; margin: 0; padding: 0; overflow: hidden; border: none"></iframe>
  </body>
</html>
"""
   if args.dry_run:
